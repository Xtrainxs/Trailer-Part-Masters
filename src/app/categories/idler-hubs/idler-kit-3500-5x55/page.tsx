...
export default function IdlerKit3500_5x55() {
  return (
    <div className="max-w-4xl mx-auto py-12 px-4">
      ...
      <h2 className="text-xl font-semibold mb-2 mt-8 text-ink">Available 3,500 lb 5x5.5 Idler Hub Kits</h2>
      <div className="overflow-x-auto">
        <table className="min-w-full bg-white border border-slate-200 rounded-lg mb-8">
          ...
          <tbody>
            <tr>
              <td className="py-2 px-4 border-b">TPM-IHK-3500-5X55</td>
            ...
            <tr>
              <td className="py-2 px-4 border-b">TPM-IHK-3500-5X55Z</td>
              <td className="py-2 px-4 border-b">5 on 5.5"</td>
              <td className="py-2 px-4 border-b">2.38"</td>
              <td className="py-2 px-4 border-b">1/2"</td>
              <td className="py-2 px-4 border-b">L68149/L68111 & L44649/L44610</td>
