...
export const metadata = { title: 'Trailer Idler Hub & Bearing Kit for 3,500 lb. Axles | 5 on 5.5\\" Bolt Pattern' };

export default function IdlerKit3500_5x55() {
  return (
    <div className="max-w-4xl mx-auto py-12 px-4">
      <h1 className="text-4xl font-bold mb-4">Trailer Idler Hub & Bearing Kit for 3,500 lb. Axles | 5 on 5.5" Bolt Pattern</h1>
      <p className="text-lg text-gray-700 mb-6">
        Durable idler hub and bearing kit for 3,500 lb axles with a 5x5.5 bolt pattern.
      </p>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
        {["1.png", "2.png", "Kit.png"].map((img, idx) => (
          ...
          >
            <img
              src={`/images/Idler%20Hubs/3500Lbs.%205%20x%205.5%20Bolt/${img}`}
              alt={`Idler Hub 3500Lbs 5x5.5 ${idx + 1}`}
      ...
      <h2 className="text-xl font-semibold mb-2 mt-8 text-[#05203C]">Available 3,500 lb 5x5.5 Idler Hub Kits</h2>
      <div className="overflow-x-auto">
        <table className="min-w-full bg-white border border-slate-200 rounded-lg mb-8">
          ...
          <tbody>
            <tr>
              <td className="py-2 px-4 border-b">BTP-IHK-3500-5X55</td>
            ...
            <tr>
              <td className="py-2 px-4 border-b">BTP-IHK-3500-5X55Z</td>
              <td className="py-2 px-4 border-b">5 on 5.5"</td>
              <td className="py-2 px-4 border-b">2.38"</td>
              <td className="py-2 px-4 border-b">1/2"</td>
              <td className="py-2 px-4 border-b">L68149/L68111 & L44649/L44610</td>
      ...
      <RequestQuoteCTA partLabel={"Trailer Idler Hub & Bearing Kit for 3,500 lb. Axles | 5 on 5.5\" Bolt Pattern"} />
    </div>
  );
}