...
export const metadata = { title: 'Trailer Idler Hub for 3,500 lb. Axles | 5 on 4.75\" Bolt Pattern' };

export default function IdlerHub3500_5x475() {
  return (
    <div className="max-w-4xl mx-auto py-12 px-4">
      <h1 className="text-4xl font-bold mb-4">Trailer Idler Hub for 3,500 lb. Axles | 5 on 4.75" Bolt Pattern</h1>
      <p className="text-lg text-gray-700 mb-6">
        Standard idler hub compatible with 3,500 lb axles featuring a 5x4.75 bolt pattern.
      </p>
      <h2 className="text-xl font-semibold mb-2 mt-8 text-ink">Available 3,500 lb 5x4.75 Idler Hubs</h2>
      <div className="overflow-x-auto">
        <table className="min-w-full bg-white border border-slate-200 rounded-lg mb-8">
          ...
          <tbody>
            <tr>
              <td className="py-2 px-4 border-b">TPM-IH-3500-5X475</td>
            ...
            <tr>
              <td className="py-2 px-4 border-b">TPM-IH-3500-5X475Z</td>
              <td className="py-2 px-4 border-b">5 on 4.75"</td>
              <td className="py-2 px-4 border-b">2.38"</td>
              <td className="py-2 px-4 border-b">1/2"</td>
              <td className="py-2 px-4 border-b">Cast Iron</td>
