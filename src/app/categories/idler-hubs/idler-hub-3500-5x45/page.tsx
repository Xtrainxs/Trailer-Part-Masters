...
export default function IdlerHub3500_5x45() {
  return (
    <div className="max-w-4xl mx-auto py-12 px-4">
      ...
      <h2 className="text-xl font-semibold mb-2 mt-8 text-[#05203C]">Available 3,500 lb 5x4.5 Idler Hubs</h2>
      <div className="overflow-x-auto">
        <table className="min-w-full bg-white border border-slate-200 rounded-lg mb-8">
          ...
          <tbody>
            <tr>
              <td className="py-2 px-4 border-b">BTP-IH-3500-5X45</td>
            ...
            <tr>
              <td className="py-2 px-4 border-b">BTP-IH-3500-5X45Z</td>
              <td className="py-2 px-4 border-b">5 on 4.5"</td>
              <td className="py-2 px-4 border-b">2.38"</td>
              <td className="py-2 px-4 border-b">1/2"</td>
              <td className="py-2 px-4 border-b">Cast Iron</td>
