...
export const metadata = { title: 'Trailer Idler Hub & Bearing Kit for 3,500 lb. Axles | 5 on 4.5\\" Bolt Pattern' };

export default function IdlerKit3500_5x45() {
  return (
    <div className="max-w-4xl mx-auto py-12 px-4">
      <h1 className="text-4xl font-bold mb-4">Trailer Idler Hub & Bearing Kit for 3,500 lb. Axles | 5 on 4.5" Bolt Pattern</h1>
      ...
      <h2 className="text-xl font-semibold mb-2 mt-8 text-[#05203C]">Available 3,500 lb 5x4.5 Idler Hub Kits</h2>
      ...
      <RequestQuoteCTA partLabel={"Trailer Idler Hub & Bearing Kit for 3,500 lb. Axles | 5 on 4.5\" Bolt Pattern"} />
    </div>
  );
}