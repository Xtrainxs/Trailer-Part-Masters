...
export const metadata = {
  ...
  description: 'Wholesale trailer electrical parts: connectors, adapters, wiring harnesses, junction boxes, breakaway kits, and battery boxes. Direct-from-manufacturer pricing for trailer builders and distributors. Min. order CAD $5,000.',
};
