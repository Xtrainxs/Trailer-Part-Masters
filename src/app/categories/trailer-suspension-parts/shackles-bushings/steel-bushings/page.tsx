...
export const metadata = {
  ...
  description: 'Wholesale Steel Bushings sourced direct from manufacturer. Bulk pricing for trailer manufacturers and stockists across Canada and the USA. Request a quote within 1-2 business days.',
};
...
export default function SteelBushingsPage() {
  return (
    <main className="max-w-4xl mx-auto py-12 px-6">
      ...
      <RequestQuoteCTA partLabel={"Steel Bushings"} />
    </main>
  );
}
