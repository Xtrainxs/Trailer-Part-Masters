...
export const metadata = {
  title: 'Spring Seats',
  description: 'Wholesale Spring Seats sourced direct from manufacturer. Bulk pricing for trailer manufacturers and stockists across Canada and the USA. Request a quote within 1-2 business days.',
};
