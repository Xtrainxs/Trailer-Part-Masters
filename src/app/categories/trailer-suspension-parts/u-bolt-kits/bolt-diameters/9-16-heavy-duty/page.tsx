...
export default function Bolt916Page() {
  return (
    <main className="max-w-4xl mx-auto py-12 px-6">
      <h1 className="text-xl font-bold mb-6 text-ink">9/16" (Heavy Duty) Bolt Diameter</h1>
      <p className="mb-8 text-ink">9/16" heavy duty bolts are designed for high-strength suspension applications, providing secure fastening for larger trailers and heavy loads.</p>
      <h2 className="text-xl font-semibold mb-2 mt-8 text-ink">Available 9/16" Heavy Duty Bolts</h2>
      <div className="overflow-x-auto">
        <table className="min-w-full bg-white border border-slate-200 rounded-lg mb-8">
          ...
          <tbody>
            ...
            <tr>
              <td className="py-2 px-4 border-b">TPM-BD916-3</td>
