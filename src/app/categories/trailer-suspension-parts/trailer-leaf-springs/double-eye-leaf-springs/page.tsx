...
export const metadata = {
  title: 'Double-Eye Leaf Springs',
  description: 'Wholesale Double-Eye Leaf Springs sourced direct from manufacturer. Bulk pricing for trailer manufacturers and stockists across Canada and the USA. Min. order CAD $5,000. Request a quote within 1-2 business days.',
};

export default function DoubleEyeLeafSpringsPage() {
  return (
    <main className="max-w-4xl mx-auto py-12 px-6">
      <h1 className="text-2xl font-bold mb-4 text-ink">Double-Eye Leaf Springs</h1>
      <p className="mb-4 text-ink">Double-Eye Leaf Springs are engineered to deliver reliable support and smooth ride quality for a wide range of trailers. Their dual-eye design ensures secure mounting and consistent load distribution, making them a popular choice for utility, boat, and cargo trailers.</p>
      <RangeDisclaimer
      ...
      />
      <h2 className="text-xl font-semibold mb-2 mt-8 text-ink">Double Eye Leaf Springs</h2>
      <p className="mb-6 text-ink">Reliable and versatile, these springs provide smooth ride quality and secure mounting for utility and cargo trailers.</p>
      ...
      <div className="flex flex-row gap-6 justify-center items-center mb-8">
        ...
        <table className="min-w-full bg-white border border-slate-200 rounded-lg mb-8">
          ...
          <tbody>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">TPM-TRA-2250-25</td>
              <td className="py-2 px-4 border-b">TRA-2250</td>
              <td className="py-2 px-4 border-b">2,250</td>
              <td className="py-2 px-4 border-b">3</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">TPM-TRA-3000-26</td>
              <td className="py-2 px-4 border-b">TRA-3000</td>
              <td className="py-2 px-4 border-b">3,000</td>
              <td className="py-2 px-4 border-b">4</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">TPM-TRA-3500-27</td>
              <td className="py-2 px-4 border-b">TRA-3500</td>
              <td className="py-2 px-4 border-b">3,500</td>
              <td className="py-2 px-4 border-b">5</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">TPM-UNA-4000-26</td>
              <td className="py-2 px-4 border-b">UNA-4000</td>
              <td className="py-2 px-4 border-b">4,000</td>
              <td className="py-2 px-4 border-b">6</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">TPM-UNA-5000-29</td>
              <td className="py-2 px-4 border-b">UNA-5000</td>
              <td className="py-2 px-4 border-b">5,000</td>
              <td className="py-2 px-4 border-b">7</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">TPM-DE-6000-28</td>
              <td className="py-2 px-4 border-b">HD</td>
              <td className="py-2 px-4 border-b">6,000</td>
              <td className="py-2 px-4 border-b">7</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">TPM-UNA-022</td>
              <td className="py-2 px-4 border-b">UNA-022</td>
              <td className="py-2 px-4 border-b">2,480</td>
              <td className="py-2 px-4 border-b">6</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">TPM-UNA-030</td>
              <td className="py-2 px-4 border-b">UNA-030</td>
              <td className="py-2 px-4 border-b">1,290</td>
              <td className="py-2 px-4 border-b">4</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">TPM-UNA-035</td>
              <td className="py-2 px-4 border-b">UNA-035</td>
              <td className="py-2 px-4 border-b">650</td>
              <td className="py-2 px-4 border-b">3</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">TPM-UNA-036</td>
              <td className="py-2 px-4 border-b">UNA-036</td>
              <td className="py-2 px-4 border-b">1,250</td>
              <td className="py-2 px-4 border-b">5</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">TPM-UNA-041</td>
              <td className="py-2 px-4 border-b">UNA-041</td>
              <td className="py-2 px-4 border-b">1,500</td>
              <td className="py-2 px-4 border-b">3</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">TPM-UNA-049</td>
              <td className="py-2 px-4 border-b">UNA-049</td>
              <td className="py-2 px-4 border-b">1,000</td>
              <td className="py-2 px-4 border-b">2</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">TPM-UNA-050</td>
              <td className="py-2 px-4 border-b">UNA-050</td>
              <td className="py-2 px-4 border-b">1,500</td>
              <td className="py-2 px-4 border-b">3</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">TPM-UNA-051</td>
              <td className="py-2 px-4 border-b">UNA-051</td>
              <td className="py-2 px-4 border-b">2,000</td>
              <td className="py-2 px-4 border-b">4</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">TPM-UNA-052</td>
              <td className="py-2 px-4 border-b">UNA-052</td>
              <td className="py-2 px-4 border-b">2,500</td>
              <td className="py-2 px-4 border-b">5</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">TPM-UNA-053</td>
              <td className="py-2 px-4 border-b">UNA-053</td>
              <td className="py-2 px-4 border-b">3,000</td>
              <td className="py-2 px-4 border-b">6</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">TPM-UNA-054</td>
              <td className="py-2 px-4 border-b">UNA-054</td>
              <td className="py-2 px-4 border-b">3,500</td>
              <td className="py-2 px-4 border-b">7</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">TPM-UNA-055</td>
