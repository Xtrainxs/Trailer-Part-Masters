...
export const metadata = { title: 'Slipper Leaf Springs' };
    ...
    <main className="max-w-4xl mx-auto py-12 px-6">
      ...
      <div className="flex flex-row gap-6 justify-center items-center mb-8">
        ...
        <table className="min-w-full bg-white border border-slate-200 rounded-lg mb-8">
          ...
          <tbody>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">BTP-UNA-013</td>
              <td className="py-2 px-4 border-b">Flat End</td>
              <td className="py-2 px-4 border-b">470</td>
              <td className="py-2 px-4 border-b">2</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">BTP-UNA-014</td>
              <td className="py-2 px-4 border-b">Flat End</td>
              <td className="py-2 px-4 border-b">705</td>
              <td className="py-2 px-4 border-b">3</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">BTP-UNA-015</td>
              <td className="py-2 px-4 border-b">Flat End</td>
              <td className="py-2 px-4 border-b">940</td>
              <td className="py-2 px-4 border-b">4</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">BTP-UNA-016</td>
              <td className="py-2 px-4 border-b">Flat End</td>
              <td className="py-2 px-4 border-b">1,184</td>
              <td className="py-2 px-4 border-b">5</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">BTP-UNA-017</td>
              <td className="py-2 px-4 border-b">Flat End</td>
              <td className="py-2 px-4 border-b">1,415</td>
              <td className="py-2 px-4 border-b">6</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">BTP-UNA-018</td>
              <td className="py-2 px-4 border-b">Flat End</td>
              <td className="py-2 px-4 border-b">300</td>
              <td className="py-2 px-4 border-b">1</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">BTP-UNA-034</td>
              <td className="py-2 px-4 border-b">Flat End</td>
              <td className="py-2 px-4 border-b">800</td>
              <td className="py-2 px-4 border-b">3</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">BTP-UNA-207</td>
              <td className="py-2 px-4 border-b">Flat End</td>
              <td className="py-2 px-4 border-b"></td>
              <td className="py-2 px-4 border-b">5</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">BTP-UNA-009</td>
              <td className="py-2 px-4 border-b">Hook End</td>
              <td className="py-2 px-4 border-b">800</td>
              <td className="py-2 px-4 border-b">3</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">BTP-UNA-010</td>
              <td className="py-2 px-4 border-b">Hook End</td>
              <td className="py-2 px-4 border-b">1,000</td>
              <td className="py-2 px-4 border-b">4</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">BTP-UNA-231</td>
              <td className="py-2 px-4 border-b">Hook End</td>
              <td className="py-2 px-4 border-b">2,500</td>
              <td className="py-2 px-4 border-b">4</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">BTP-UNA-233</td>
              <td className="py-2 px-4 border-b">Hook End</td>
              <td className="py-2 px-4 border-b">4,000</td>
              <td className="py-2 px-4 border-b">7</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">BTP-UNA-300</td>
              <td className="py-2 px-4 border-b">Hook End</td>
              <td className="py-2 px-4 border-b">4,000</td>
              <td className="py-2 px-4 border-b">7</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">BTP-UNA-176N</td>
            ...
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">BTP-UNA-177N</td>
              <td className="py-2 px-4 border-b">Radius End</td>
              <td className="py-2 px-4 border-b">500</td>
              <td className="py-2 px-4 border-b">2</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">BTP-UNA-178</td>
              <td className="py-2 px-4 border-b">Radius End</td>
              <td className="py-2 px-4 border-b">750</td>
              <td className="py-2 px-4 border-b">3</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">BTP-UNA-179</td>
              <td className="py-2 px-4 border-b">Radius End</td>
              <td className="py-2 px-4 border-b">950</td>
              <td className="py-2 px-4 border-b">4</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">BTP-UNA-180</td>
              <td className="py-2 px-4 border-b">Radius End</td>
              <td className="py-2 px-4 border-b"></td>
              <td className="py-2 px-4 border-b">5</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">BTP-UNA-232</td>
              <td className="py-2 px-4 border-b">Radius End</td>
              <td className="py-2 px-4 border-b">3,500</td>
              <td className="py-2 px-4 border-b">5</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">BTP-UNA-299</td>
              <td className="py-2 px-4 border-b">Radius End</td>
              <td className="py-2 px-4 border-b">3,500</td>
              <td className="py-2 px-4 border-b">5</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">BTP-UNA-318</td>
              <td className="py-2 px-4 border-b">Radius End</td>
              <td className="py-2 px-4 border-b">8,000</td>
              <td className="py-2 px-4 border-b">6</td>
            </tr>
            <tr>
              <td className="py-2 px-4 border-b font-semibold whitespace-nowrap">BTP-TRA-2740</td>
              <td className="py-2 px-4 border-b">Radius End</td>
