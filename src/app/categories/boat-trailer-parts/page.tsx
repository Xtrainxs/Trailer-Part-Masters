...
export const metadata = {
  ...
  description: 'Wholesale boat trailer parts: hand and electric winches, rollers, keel and bow rollers, jacks, guides, bunks, safety chains, and marine hardware. Factory-direct pricing for marine trailer manufacturers. Min. order CAD $5,000.',
};
