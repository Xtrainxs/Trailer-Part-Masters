...
export const metadata = {
  title: 'Top-Wind Jacks',
  description: 'Wholesale Top-Wind Jacks sourced direct from manufacturer. Bulk pricing for trailer manufacturers and stockists across Canada and the USA. Min. order CAD $5,000. Request a quote within 1-2 business days.',
};
    ...
    <div className="max-w-4xl mx-auto py-12 px-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {["1.png", "2.png", "3.png", "4.png"].map((img, idx) => (
          ...
          >
            <img
              src={`/images/Trailer%20Jacks/Top%20Wind%20Jacks/${img}`}
