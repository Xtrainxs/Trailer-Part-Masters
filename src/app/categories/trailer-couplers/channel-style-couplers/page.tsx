...
export const metadata = {
  ...
  description: 'Wholesale Channel Style Couplers sourced direct from manufacturer. Bulk pricing for trailer manufacturers and stockists across Canada and the USA. Request a quote within 1-2 business days.',
};
