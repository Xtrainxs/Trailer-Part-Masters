...
export const metadata = {
  ...
  description: 'Wholesale Adjustable Couplers sourced direct from manufacturer. Bulk pricing for trailer manufacturers and stockists across Canada and the USA. Request a quote within 1-2 business days.',
};
...
export default function AdjustableCouplers() {
  return (
    <div className="max-w-4xl mx-auto py-12 px-4">
      ...
      <h2 className="text-xl font-semibold mb-2 mt-8 text-ink">Available Adjustable Couplers</h2>
